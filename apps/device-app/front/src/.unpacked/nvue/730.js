...
(function (e, t, n) {
  ...
  var r = a(require("@/.unpacked/nvue/22.js")), i = a(require("@/.unpacked/nvue/23.js")), o = a(require("@/.unpacked/nvue/5.js")), s = require("vuex"), d = require("../../common/utils.nvue.js"), u = a(require("../../components/verificationCode/verificationCode.nvue"));
  function l(e, t) {
    var n = Object.keys(e);
  ...
  var c, m = getApp().globalData, f = {
    ...
    methods: _(_({}, (0, s.mapActions)("account", ["ResetPassword"])), {}, {
      l: function (e) {
        return m.$t(e);
      },
        ...
        return (0, i.default)(r.default.mark(function t() {
          return r.default.wrap(function (t) {
            for (; ; ) switch (t.prev = t.next) {
              ...
              case 8:
                return (t.next = 10, e.ResetPassword({
                  phoneNumber: e.userPhone.trim(),
                  code: e.code.trim(),
                  password: e.userPwd.trim()
                }));
              case 10:
                t.sent.succeeded && ((0, d.qzwlToast)(m.$t("common.resettingting.successful"), "none"), c = setTimeout(function () {
                  uni.navigateBack();
                }, 1500));
              case 12:
              case "end":
