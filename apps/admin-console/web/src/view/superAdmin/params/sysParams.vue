  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        />
        <el-table-column align="left" label="参数键" prop="key" width="120" show-overflow-tooltip />
        <el-table-column align="left" label="参数值" prop="value" width="120" show-overflow-tooltip/>
        <el-table-column
          align="left"
          label="参数说明"
          prop="desc"
